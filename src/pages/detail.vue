            ...
            <div class="container clearfix">
                <div class="swiper">
                    <swiper :options="swiperOption">
                        <swiper-slide>
                            <img :src="require('/public/imgs/detail/phone-1.jpg')" alt="" />
                        </swiper-slide>
                        <swiper-slide>
                            <img :src="require('/public/imgs/detail/phone-2.jpg')" alt="" />
                        </swiper-slide>
                        <swiper-slide>
                            <img :src="require('/public/imgs/detail/phone-3.jpg')" alt="" />
                        </swiper-slide>
                        <swiper-slide>
                            <img :src="require('/public/imgs/detail/phone-4.jpg')" alt="" />
                        </swiper-slide>
                        <!-- Optional controls -->
